...
export const readFileNode = defineNode({
	...
	runtimeOutputs: fallible([
		{ name: "path", type: "string", description: "File path read by the runner.", example: "n-mr3zyt6f-19.path" },
		{
			name: "content",
			type: "string",
		...
		{ name: "bytes", type: "integer", description: "Number of bytes read.", example: "n-mr3zyt6f-19.bytes" },
	]),
