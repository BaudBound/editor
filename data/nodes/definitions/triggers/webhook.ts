...
export const webhookTriggerNode = defineNode({
	...
	configFields: [
		...
		{ key: "responseTimeoutSeconds", label: "Response timeout seconds", type: "number", required: false },
		{ key: "timeoutResponseStatus", label: "Fallback response status", type: "number", required: false },
		{
