	...
	return (
		<section className="space-y-6">
			...
			<div className="space-y-3">
				...
				<div className="grid gap-2">
					<InfoCard>
						Target runtime compatibility is enforced for every selected target before export and during import. Get
						Pixel Color, Get Active Window, and Window Focus currently require Windows Desktop because those runner
						actions use native Win32 desktop APIs.
					</InfoCard>
					<InfoCard>
